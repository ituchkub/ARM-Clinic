...
const columns = [
  ...
  { label: "จำนวนทั้งหมด", size: "lg", width: "25%" },
  { label: "จำนวนคงเหลือ", size: "lg", width: "25%" },
...
const onLoadData = async () => {
  ...
  await _apiProductStock.getStockList(
        ...
        <div class="mt-3 mb-3">
          <div class="flex flex-wrap flex-row">
            ...
            <div class="px-3 basis-1/5 mb-3">
              <label class="label font-bold">จำนวนทั้งหมด <span style="color: red">*</span></label>
            ...
            <div class="px-3 basis-2/5 mb-3">
              <label class="label font-bold">จำนวนคงเหลือ <span style="color: red">*</span></label>
